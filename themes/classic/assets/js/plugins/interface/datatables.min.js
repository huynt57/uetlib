...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"Không có dữ liệu nào trong bảng",sInfo:"Hiển thị _START_ đến _END_ của _TOTAL_ bản ghi",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(Lọc từ _MAX_ total bản ghi)",sInfoPostFix:"",sDecimal:"",
