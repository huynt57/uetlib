<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#search-book-id" data-toggle="tab"><i class="icon-table2"></i>Tìm kiếm theo mã sách</a></li>
        <li><a href="#search-book-name" data-toggle="tab"><i class="icon-checkbox-partial"></i> Tìm kiếm theo tên sách</a></li>
        <li><a href="#search-student-id" data-toggle="tab"><i class="icon-checkbox-partial"></i> Tìm kiếm theo mã sinh viên</a></li>
        <li><a href="#search-student-name" data-toggle="tab"><i class="icon-checkbox-partial"></i> Tìm kiếm theo tên sinh viên</a></li>
    </ul>
    <div class="tab-content">
        ...
        <div class="tab-pane active fade in" id="default">
            fgdsf
        </div>
        <!-- /second tab -->
